...
FUNCTION(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
	...
	ADD_CUSTOM_TARGET(${_targetname}
		...
		COMMAND ${LCOV_PATH} -c -i -d . -o ${_outputname}_base.info
		
		# Run tests
		COMMAND ${_testrunner} ${ARGV3}
		
		# Capturing lcov counters and generating report
		COMMAND ${LCOV_PATH} --directory . --capture --output-file ${_outputname}_test.info
        COMMAND ${LCOV_PATH} -a ${_outputname}_base.info -a ${_outputname}_test.info -o ${_outputname}.info
